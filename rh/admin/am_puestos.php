 ...
 <script>
        $(document).ready(function ()
            ...
            function submitClicked()
            {
                if($("#frmAdeudo").valid())
                {
                    if(confirm("¿Desea agregar el puesto?"))
                    {
                        
                        /** Datos */
                        var puesto    = $("#puesto_nombre").val();
             

                        $.ajax({
                            type: "POST",
                            url: "insert.php",
                            data: "dcrpuesto=" +puesto+"&tipoInsert=puesto",
   ...
   <div class="titulo">Puestos<br>
    ...
    <tr>
     <td class="derecha">
        ...
        <td style="width:75%;">
            <input type="text" id="puesto_nombre" name="puesto_nombre" maxlength="100" style="width:80%;">
        </td>
    </tr>
