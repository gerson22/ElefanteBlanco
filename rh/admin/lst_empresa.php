...
<section id="contenedor">
   ...
   <div class="titulo"><br><br>Empresas<br>
    ...
    if($empresas != '')
    {
             ...
             echo '<tr class=tlistado><td>No.</td><td style="width:75%;">Empresa</tr>';
       $cont=0;
                               
                                    foreach($empresas as $empresa)
                                    {
                                       $cont++;
                                          echo '<tr><td class=centrar>'.$cont.'</td><td class=centrar>'.utf8_decode($empresa['nombre_empresa']).'</td></tr>';
                                    }
