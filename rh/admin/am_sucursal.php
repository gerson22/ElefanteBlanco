...
<section id="contenedor">
   ...
   <div class="titulo">Sucursal<br>
    ...
    <tr>
     <td class="derecha">
        ...
        <td style="width:75%;" class="izq">
         <select name="empresa" id="empresa" style="width:90%;" onchange="cargaComboDepto()"><option value="">Selecciona</option>
             <?php
    ...
    if($empresas != '')
    {
                                    ...
                                    {
                                       $cont++;
                                          echo '<option value='.$empresa['id_empresa'].'>'.utf8_encode($empresa['nombre_empresa']).'</option>';
     ...
     <td class="derecha">
        ...
        <td style="width:75%;" class="izq">
            <input type="text" id="suc_nombre" name="suc_nombre" maxlength="100" style="width:90%;">
        </td>
        </tr>
